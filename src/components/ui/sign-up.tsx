					...
					<CardContent className='grid gap-y-5 pt-4'>
						...
						<div className='space-y-2'>
							...
							<div className='grid grid-cols-2 gap-3'>
								<div
									onClick={() => setAccountType('teens')}
									className={`relative cursor-pointer rounded-lg border p-2.5 transition-all duration-200 hover:border-primary/50 ${
										accountType === 'teens'
								...
								>
									<input
										...
										name='user_type'
										value='teens'
										checked={accountType === 'teens'}
										onChange={() => setAccountType('teens')}
										className='sr-only'
										required
									/>
								...
								>
									<input
										...
										name='user_type'
										value='kids'
										checked={accountType === 'kids'}
										onChange={() => setAccountType('kids')}
										className='sr-only'
										required
									/>
									<div className='flex items-center gap-2.5'>
