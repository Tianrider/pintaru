...
export async function createStorybook(tema: string, character: string, onProgress?: ProgressCallback) {
  const totalSteps = 12;
  ...
  const image2 = await executeStepN(3, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image3 = await executeStepN(4, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image4 = await executeStepN(5, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image5 = await executeStepN(6, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image6 = await executeStepN(7, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image7 = await executeStepN(8, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image8 = await executeStepN(9, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image9 = await executeStepN(10, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image10 = await executeStepN(11, teksCerita.data, image1.success ? image1.data : undefined);
  ...
  const image0 = await executeStep12(teksCerita.data, image1.success ? image1.data : undefined);
