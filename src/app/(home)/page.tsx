						...
						<div className="flex flex-col md:flex-row gap-8 md:gap-6 lg:gap-10 justify-center items-stretch">
							...
							<div className="flex flex-row items-center gap-3 w-full md:w-1/3">
								...
								<div className="flex flex-col gap-1">
									...
									<p className="text-sm sm:text-base">
										Temukan jawaban lengkap dalam hitungan
										detik kapan saja.
									</p>
								</div>
							</div>
							<div className="flex flex-row items-center gap-3 w-full md:w-1/3">
								...
								<div className="flex flex-col gap-1">
									...
									<p className="text-sm sm:text-base">
										Nikmati pembelajaran visual langkah demi
										langkah yang mudah dipahami.
									</p>
								</div>
							</div>
						</div>
						...
						<div className="max-w-5xl w-full flex flex-col md:flex-row-reverse gap-8 md:gap-24 items-center">
							...
							<div className="w-full md:w-1/2 space-y-4 sm:space-y-6">
								...
								<p className="text-base sm:text-lg text-gray-700 leading-relaxed">
									Jawab.in adalah platform pembelajaran
									inovatif yang menggabungkan kekuatan AI
									dengan pendekatan visual untuk membantu
									siswa memahami pelajaran dengan lebih baik.
									Dengan teknologi AI canggih, kami dapat
									memberikan penjelasan yang disesuaikan
									dengan gaya belajar setiap siswa, dilengkapi
									dengan video pembelajaran yang interaktif
									dan mudah dipahami.
								</p>
							...
							<div className="flex flex-col gap-4">
								...
								<div className="flex flex-col gap-3">
									...
									<div className="flex items-center gap-2">
										...
										<a href="https://instagram.com/jawab.in">
											pintaru.id
										</a>
									</div>
								</div>
